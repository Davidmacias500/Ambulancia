...
<head>
  ...
  <link rel="stylesheet" href="adminlte/css/bootstrap/dist/css/bootstrap.min.css">
  <!-- Font Awesome -->
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="adminlte/css/dist/css/AdminLTE.min.css">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Aalak'</b>SOFT</span>
    </a>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <img src="adminlte/css/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
...
<!--                   <div class="col-xs-4 text-center">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2019 <a href="#">CDM SOFT</a>.</strong> All rights reserved.
  </footer>
...
<!-- Bootstrap 3.3.7 -->
<script src="adminlte/css/bootstrap/dist/js/bootstrap.min.js"></script>
<!-- AdminLTE App -->
